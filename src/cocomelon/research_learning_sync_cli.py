...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="cocomelon-research-learning-sync",
        description=(
            "Ingest authenticated required-candidate paper outcomes from a completed "
            "research campaign into cumulative learning state"
        ),
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        receipt = sync_research_campaign_learning(
            args.campaign_root,
