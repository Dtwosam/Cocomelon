...
class FeatureSnapshotRecorder(Protocol):
...
class BaselineReplayPipeline:
    def __init__(
        ...
        *,
        ...
        feature_snapshot_recorder: FeatureSnapshotRecorder | None = None,
    ) -> None:
        ...
        self._feature_snapshot_recorder = feature_snapshot_recorder
    ...
    def _process_epoch(self, epoch: DecisionEpoch) -> tuple[JournalObservation, ...]:
        ...
        for evaluation in epoch.markets:
            ...
            if self._feature_snapshot_recorder is not None:
                self._feature_snapshot_recorder.record(evaluation.feature)
