...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="cocomelon-prospective-hype-health",
        description=(
            "Report frozen prospective HYPE campaign recoverability without "
...
def prospective_hype_health_payload(
    *,
    root: Path,
    ...
    return {
        "command": "prospective-hype-health",
        **health.to_dict(),
