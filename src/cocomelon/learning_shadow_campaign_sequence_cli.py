...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="cocomelon-learning-shadow-sequence",
        description=(
            "Check whether one successful paper campaign is the next contiguous "
            "campaign required by a durable learned shadow-state lineage"
        ),
    )
