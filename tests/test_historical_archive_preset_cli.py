...
from cocomelon.research.historical_archive_presets import JUL_SEP_2026_V1


class ForbiddenSettings:
    @classmethod
    def from_env(cls) -> object:
        raise AssertionError("show must not read runtime settings")
...
def test_show_is_offline_and_emits_frozen_preset(
    ...
    assert payload["name"] == JUL_SEP_2026_V1.name
