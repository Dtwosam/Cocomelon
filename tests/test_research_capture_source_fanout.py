...
def test_capture_source_is_candidate_neutral_and_reusable(tmp_path: Path) -> None:
    ...
    assert root_candidate.code_revision != source.code_revision
    assert challenger.code_revision != source.code_revision
    assert root_bundle.manifest.code_revision == source.code_revision
    assert challenger_bundle.manifest.code_revision == source.code_revision
    assert root.code_revision == source.code_revision
    assert alternate.code_revision == source.code_revision
